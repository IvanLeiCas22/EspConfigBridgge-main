...
public:
    ...
    void setupUi(QDialog *SettingsDialog)
    {
        ...
        QFont font;
        font.setFamilies({QString::fromUtf8("Courier 10 Pitch")});
        ...
        pushButtonRefresh = new QPushButton(SettingsDialog);
    ...
    void retranslateUi(QDialog *SettingsDialog)
    {
        ...
        pushButtonRefresh->setText(QCoreApplication::translate("SettingsDialog", "Refresh", nullptr));
